 ...
 */
export interface TypedDoc<Maps extends Record<string, TypedMap<any>> = Record<string, TypedMap<any>>, Arrays extends Record<string, TypedArray<any>> = Record<string, TypedArray<any>>, Texts extends Record<string, Y.Text> = Record<string, Y.Text>, XmlFragments extends Record<string, Y.XmlFragment> = Record<string, Y.XmlFragment>> extends Y.Doc {
    /**
 ...
 */
export interface TypedMap<Data> extends Y.Map<any> {
    /**
